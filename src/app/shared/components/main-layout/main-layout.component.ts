...
export class MainLayoutComponent {
  ...
  readonly navItems: NavItem[] = [
    ...
    { label: 'Balance Gremial', icon: 'account_balance', route: '/wallet', roles: ['ADMIN', 'CALLER', 'OFFICER'], exact: true },
    { label: 'Mi Balance', icon: 'account_balance_wallet', route: '/wallet', roles: ['PLAYER'], exact: true },
    ...
    { label: 'Movimientos', icon: 'swap_horiz', route: '/wallet/transactions', roles: ['ADMIN', 'CALLER', 'OFFICER'], exact: true },
    { label: 'Solicitudes', icon: 'payments', route: '/withdrawals', exact: true },
